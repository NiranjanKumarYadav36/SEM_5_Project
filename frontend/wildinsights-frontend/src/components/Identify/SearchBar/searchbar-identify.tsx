...
const SearchBarIdentify: React.FC<SearchComponentProps> = ({ onSearch }) => {
  ...
  return (
    <Box display={"flex"} alignItems={"center"} justifyContent={"space-around"} sx={{background:"#D3D3D3"}}>
...
export default SearchBarIdentify;